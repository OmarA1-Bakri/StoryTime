# StoryTime Naming Standard

Canonical product name: StoryTime.
...
Do not introduce the older StoriTime spelling in new product, app, package, or documentation work.
