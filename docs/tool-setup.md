# Tool Setup — Historical Snapshot

Status: historical 2026-06-28 discovery; re-verify before external writes.

The current canonical account/deployment inventory belongs in
[current-state.md](current-state.md) and Phase 0 of
[../IMPLEMENTATION_PLAN.md](../IMPLEMENTATION_PLAN.md). Tool names, connections,
permissions, and provider availability can change. Never infer that an old
“available” entry means production is configured or safe.
